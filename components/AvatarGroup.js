...
import React, { cloneElement, forwardRef, useLayoutEffect, useImperativeHandle, useRef, useState, } from 'react';
...
export var AvatarGroup = forwardRef(function (_a, ref) {
    var _b;
    var children = _a.children, _c = _a.name, name = _c === void 0 ? 'C4tAvatarGroup' : _c, inputProps = __rest(_a, ["children", "name"]);
    var _d = useState([]), $avatars = _d[0], set$avatars = _d[1];
    ...
    useLayoutEffect(function () {
        ...
        var customSurplus = (_d = (_c = withProps.renderSurplus) === null || _c === void 0 ? void 0 : _c.call(withProps, remaining)) !== null && _d !== void 0 ? _d : null;
        ...
        var $avatars = [];
        var $elements = __spreadArray(__spreadArray([], children.slice(0, $elCount > max ? max - 1 : max), true), ($elCount > max || withProps.total ? (customSurplus ? [customSurplus] : [
            _jsxs(Avatar, __assign({ boxProps: {
                    $bColor: 'grey',
                    $bgColor: 'grey',
                } }, { children: ["+", remaining] }), 'fixed-plus-count')
        ]) : []), true);
        for (var _h = 0, $elements_1 = $elements; _h < $elements_1.length; _h++) {
            var child = $elements_1[_h];
            var boxProps = child.key === 'plus-count' ? ((_e = child.props.boxProps) !== null && _e !== void 0 ? _e : {}) : __assign(__assign(__assign(__assign(__assign(__assign(__assign(__assign({}, (withProps.$bColor && { $bColor: withProps.$bColor })), (withProps.$bColorVariant && { $bColorVariant: withProps.$bColorVariant })), (withProps.$bRadius && { $bRadius: withProps.$bRadius })), (withProps.$bShape && { $bShape: withProps.$bShape })), (withProps.$bSize && { $bSize: withProps.$bSize })), (withProps.$bgColor && { $bgColor: withProps.$bgColor })), (withProps.$bgColorVariant && { $bgColorVariant: withProps.$bgColorVariant })), ((_f = child.props.boxProps) !== null && _f !== void 0 ? _f : {}));
            var newAvatar = cloneElement(child, __assign(__assign({}, child.props), { boxProps: boxProps, variant: (_g = child.props.variant) !== null && _g !== void 0 ? _g : withProps.variant }));
    ...
    return (_jsx(StyledBox, __assign({ className: getClassName(withProps, name, withProps.variant), jCss: jCss, ref: innerRef, variant: (_b = withProps.boxVariant) !== null && _b !== void 0 ? _b : 'auto-fit-no-padding' }, _objectWithoutProperties(withProps, [
        'boxVariant',
        'className',
        'flipContent',
        'jCss',
