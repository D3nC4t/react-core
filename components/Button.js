...
var StyledButton = styled('button', {
  ...
  return (__assign(__assign(__assign(__assign({
    ...
    padding: "".concat(theme.spacing.xs).concat(theme.shape.unit, " ").concat(theme.spacing.s).concat(
      theme.shape.unit),
  })), (props.size === 'large' && {
    padding: "".concat(theme.spacing.s).concat(theme.shape.unit, " ").concat(theme.spacing.ml).concat(
      theme.shape.unit),
...
export var Button = forwardRef(function(_a, ref) {
  ...
  return (_jsxs(StyledButton, __assign({
    ...
    children: [withProps.startIcon && _jsx(Icon, __assign({}, withProps.startIconProps, {
      className: 'start-icon',
      icon: withProps.startIcon
    })), _jsx(Typography, __assign({}, withProps.typographyProps, {
      children: children
    })), withProps.endIcon && _jsx(Icon, __assign({}, withProps.endIconProps, {
      className: 'end-icon',
      icon: withProps.endIcon
    }))]
  })));
});
