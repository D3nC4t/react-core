...
export var ButtonGroup = forwardRef(function (_a, ref) {
    var children = _a.children, _b = _a.name, name = _b === void 0 ? 'C4tButtonGroup' : _b, inputProps = __rest(_a, ["children", "name"]);
    ...
    return (_jsx(StyledButtonGroup, __assign({ className: getClassName(withProps, name, withProps.variant), name: name, ref: ref }, _objectWithoutProperties(withProps, [
        'className',
    ]), { children: children })));
});
