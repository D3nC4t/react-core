...
import { forwardRef, useCallback, useState, useLayoutEffect, } from 'react';
import Box from './Box';
...
export var CircularLoading = forwardRef(function (_a, ref) {
    var _b = _a.name, name = _b === void 0 ? 'C4tCircularLoading' : _b, inputProps = __rest(_a, ["name"]);
    var _c = useState([]), $lines = _c[0], set$lines = _c[1];
    ...
    var getClass = useCallback(function () {
        ...
        return getClassName.apply(void 0, __spreadArray([withProps, name, (_a = withProps.variant) !== null && _a !== void 0 ? _a : 'root'], mutations, false));
    ...
    useLayoutEffect(function () {
        ...
        for (var i = 0; i < nLines; i++) {
            $lines.push((_b = (_a = withProps.lines$el) === null || _a === void 0 ? void 0 : _a[i]) !== null && _b !== void 0 ? _b : (_jsx(StyledSpan, __assign({ jCss: (_c = withProps.linesJCss) === null || _c === void 0 ? void 0 : _c[i], className: getClass('inner', 'line') }, { children: _jsx(StyledSpan, { className: getClass('inner', 'line', 'track') }) }), i)));
        }
        set$lines($lines);
