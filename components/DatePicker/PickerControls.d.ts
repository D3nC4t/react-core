...
export interface PickerControlsProps extends Omit<BoxProps, 'children'> {
    /**
...
export declare const PickerControls: ForwardRefExoticComponent<PickerControlsProps & RefAttributes<HTMLDivElement>>;
