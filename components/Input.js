...
export var Input = forwardRef(function (_a, ref) {
    ...
    var _h = _a.name, name = _h === void 0 ? 'C4tInput' : _h, inputProps = __rest(_a, ["name"]);
    var theme = useTheme();
    var _j = useState(false), focused = _j[0], setFocused = _j[1];
    var _k = useState(0), paddingEnd = _k[0], setPaddingEnd = _k[1];
    var _l = useState(0), paddingStart = _l[0], setPaddingStart = _l[1];
    ...
    return (_jsxs(Box, __assign({ className: getClassName((_c = withProps.boxProps) !== null && _c !== void 0 ? _c : {}, name, 'box')
        ...
        'variant',
                ...
                }, ref: innerRef, style: __assign(__assign({}, (paddingStart > 0 && { paddingLeft: theme.get.rem(paddingStart, 'px') })), (paddingEnd > 0 && { paddingRight: theme.get.rem(paddingEnd, 'px') })), value: value }, _objectWithoutProperties(withProps, [
                'boxProps',
                'endAdornment',
                'className',
                'jCss',
                ...
                'value',
                'width',
            ]))), _jsx("input", { name: (_g = withProps.inputName) !== null && _g !== void 0 ? _g : name, type: 'hidden', value: value, readOnly: true, style: { display: 'none' } }), withProps.endAdornment && isValidElement(withProps.endAdornment) && (_jsx(Box, __assign({ className: "".concat(baseClassName, "__end-adornment"), ref: endAdornmentRef, tag: 'i', variant: 'no-padding' }, { children: withProps.endAdornment })))] })));
});
