...
export var LocaleSelector = forwardRef(function (_a, ref) {
    var _b = _a.name, name = _b === void 0 ? 'C4tLocaleSelector' : _b, inputProps = __rest(_a, ["name"]);
    ...
    return (_jsx(Select, __assign({ className: getClassName(withProps, name, withProps.variant), jCss: jCss, ref: ref }, _objectWithoutProperties(withProps, [
        'className',
        'jCss',
        'variant',
    ]), { children: options.map(function (option) { return (_jsx("span", { children: option.children }, option.key)); }) })));
});
