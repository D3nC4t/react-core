...
export var Modal = forwardRef(function (_a, ref) {
    var children = _a.children, _b = _a.name, name = _b === void 0 ? 'C4tModal' : _b, inputProps = __rest(_a, ["children", "name"]);
    ...
    return (_jsx(Portal, __assign({ className: getClassName(withProps, name, withProps.variant), jCss: jCss, onOpen: function () {
            var _a;
            ...
            setIsOpen(false);
        }, open: isOpen, ref: ref, variant: withProps.portalVariant }, _objectWithoutProperties(withProps, [
        'className',
        'jCss',
        'onOpen',
        'onClose',
