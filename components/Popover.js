...
import { debounce, getRem } from '../utils';
import { useDefaultProps, useVariantJCss } from '../theme';
import { PopoverAnchorType, } from '../types/components/Popover';
...
function getTransformOriginValue(transformOrigin) {
    ...
    ].map(function (n) { return typeof n === 'number' ? getRem(n) : n; }).join(' ');
}
...
export var Popover = forwardRef(function (_a, ref) {
    ...
    var children = _a.children, _k = _a.name, name = _k === void 0 ? 'C4tPopover' : _k, inputProps = __rest(_a, ["children", "name"]);
    var _l = useState(false), isOpen = _l[0], setIsOpen = _l[1];
    var _m = useState(null), $anchor = _m[0], set$anchor = _m[1];
    var _o = useState(PopoverAnchorType.none), anchorReference = _o[0], setAnchorReference = _o[1];
    ...
    var getAnchorOffset = useCallback(function () {
        ...
        return {
            left: box.left + getOffsetLeft(box, (_d = (_c = withProps.$anchorOrigin) === null || _c === void 0 ? void 0 : _c.horizontal) !== null && _d !== void 0 ? _d : 'left'),
            top: box.top + getOffsetTop(box, (_f = (_e = withProps.$anchorOrigin) === null || _e === void 0 ? void 0 : _e.vertical) !== null && _f !== void 0 ? _f : 'bottom')
        };
    }, [
        anchorReference,
        $anchor,
    ...
    var getTransformOrigin = useCallback(function (elemRect) {
        var _a, _b, _c, _d;
        return ({
            horizontal: getOffsetLeft(elemRect, (_b = (_a = withProps.$transformOrigin) === null || _a === void 0 ? void 0 : _a.horizontal) !== null && _b !== void 0 ? _b : 'left'),
            vertical: getOffsetTop(elemRect, (_d = (_c = withProps.$transformOrigin) === null || _c === void 0 ? void 0 : _c.vertical) !== null && _d !== void 0 ? _d : 'top')
        });
    }, [(_d = withProps.$transformOrigin) === null || _d === void 0 ? void 0 : _d.horizontal, (_e = withProps.$transformOrigin) === null || _e === void 0 ? void 0 : _e.vertical]);
    var getPositioningStyle = useCallback(function (element) {
        ...
        var containerWindow = (_a = $anchor === null || $anchor === void 0 ? void 0 : $anchor.ownerDocument.defaultView) !== null && _a !== void 0 ? _a : window;
    ...
    var handleEntering = useCallback(function (element, isAppearing) {
        ...
        (_d = (_c = (_b = withProps.$backdropProps) === null || _b === void 0 ? void 0 : _b.$fadeProps) === null || _c === void 0 ? void 0 : _c.onEntering) === null || _d === void 0 ? void 0 : _d.call(_c, element, isAppearing);
        setPositioningStyles();
    }, [
        $anchor,
        anchorReference,
        setPositioningStyles,
        (_g = (_f = withProps.$backdropProps) === null || _f === void 0 ? void 0 : _f.$fadeProps) === null || _g === void 0 ? void 0 : _g.onEntering,
    ...
    return (_jsx(Portal, __assign({ "$backdropProps": __assign(__assign({}, withProps.$backdropProps), { $fadeProps: __assign(__assign({}, ((_j = (_h = withProps.$backdropProps) === null || _h === void 0 ? void 0 : _h.$fadeProps) !== null && _j !== void 0 ? _j : {})), { onEntering: handleEntering }) }), jCss: jCss, name: name, onClose: function () {
            var _a;
            ...
            setIsOpen(true);
        }, open: isOpen, ref: innerRef, variant: withProps.variant }, _objectWithoutProperties(withProps, [
        '$backdropProps',
        'jCss',
        'name',
        'onClose',
