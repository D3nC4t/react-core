...
export var Switch = forwardRef(function (_a, ref) {
    var _b;
    var _c = _a.name, name = _c === void 0 ? 'C4tSwitch' : _c, inputProps = __rest(_a, ["name"]);
    ...
    return (_jsxs(Box, __assign({ className: getClassName(withProps, name, withProps.variant), jCss: __assign({ position: 'relative' }, jCss), ref: ref, variant: 'auto-fit-no-padding', onClick: handleOnClick }, _objectWithoutProperties(withProps, [
        'className',
        'inputName',
        'jCss',
        'onClick',
        'variant',
    ]), { children: [_jsx(StyledSwitch, { className: getClassName(withProps, name, withProps.variant, 'thumb')
                    + (state ? ' checked' : '') }), _jsx("input", { style: { display: 'none' }, name: (_b = withProps.inputName) !== null && _b !== void 0 ? _b : name, type: 'radio', readOnly: true, value: state ? 'on' : 'off' })] })));
});
