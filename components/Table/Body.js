...
var DISPLAY_NAME = 'C4tTableBody';
export var Body = forwardRef(function(_a, ref) {
  var _b;
  ...
  useEffect(function() {
    if (!Array.isArray(children)) {
      validateChildComponent('Body', children, 'TableRow', Row);
      return;
    }
    ...
    for (var _i = 0, children_1 = children; _i < children_1.length; _i++) {
      ...
      validateChildComponent('Body', node, 'TableRow', Row);
    }
  }, [children]);
