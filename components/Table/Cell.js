...
var DISPLAY_NAME = 'C4tTableCell';
export var Cell = forwardRef(function(_a, ref) {
  var _b, _c;
  ...
  return (_jsx(Box, __assign({
    ...
    jCss: jCss,
    ref: ref,
    tag: (_b = withProps.tag) !== null && _b !== void 0 ? _b : 'td',
    variant: (_c = withProps.boxVariant) !== null && _c !== void 0 ? _c : 'no-padding'
