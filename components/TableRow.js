...
export var TableRow = forwardRef(function (_a, ref) {
    var _b;
    var children = _a.children, _c = _a.name, name = _c === void 0 ? 'C4tTableRow' : _c, inputProps = __rest(_a, ["children", "name"]);
    ...
    return (_jsx(Box, __assign({ className: getClassName(withProps, name, withProps.variant)
            + ' ' + getClassName({}, name, 'box'), jCss: jCss, ref: ref, tag: 'tr', variant: (_b = withProps.boxVariant) !== null && _b !== void 0 ? _b : 'no-padding' }, _objectWithoutProperties(withProps, [
        'boxVariant',
        'className',
        'jCss',
        'variant',
