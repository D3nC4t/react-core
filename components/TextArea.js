...
export var TextArea = forwardRef(function(_a, ref) {
  ...
  return (_jsxs(StyledBox, __assign({
    className: getClassName((_b = withProps.boxProps) !== null && _b !== void 0 ? _b : {}, name, 'box') +
      (focused ? " focused" : '') +
    ...
    children: [_jsx(StyledTextArea, __assign({
      className: getClassName(withProps, name, withProps.variant),
      jCss: __assign({
        resize: (_c = withProps.resize) !== null && _c !== void 0 ? _c : 'vertical',
        width: (_d = withProps.width) !== null && _d !== void 0 ? _d : theme.get.rem(128, 'px')
      }, jCss),
      name: name,
      ...
      rows: (_e = withProps.rows) !== null && _e !== void 0 ? _e : 3,
      defaultValue: value
