import type { Config, ConfigSubscriptionFn, UnsubscribeConfigCallback } from '../types';
import { ConfigMigrationFn } from '../types';
...
export declare const setConfig: <T extends string>(prop: T, value: Config[T], forceValue?: boolean) => void;
export declare const defineConfig: <T extends string>(prop: T, value: Config[T], migration?: ConfigMigrationFn<T> | undefined) => void;
