...
export var Default = {
  ...
  render: function(props) {
    return (_jsx(Alert, __assign({}, props, {
...
export var WithCustomButton = {
  ...
  render: function(props) {
    return (_jsx(LocaleProvider, __assign({
      ...
      children: _jsx(Alert, __assign({}, props, {
        extraAction: (_jsx(Button, __assign({
          variant: 'outlined'
        }, {
          children: _jsx(FormattedMessage, {
            id: 'alert.extra-action.button'
          })
        })))
      }, {
        children: _jsx(FormattedMessage, {
          id: 'alert.extra-action'
        })
      }))
    })));
  },
...
var renderSeverities = function(props) {
  ...
  for (var _i = 0, _a = ['error', 'info', 'success', 'warning']; _i < _a.length; _i++) {
    var severity = _a[_i];
    $elements.push(_jsx(Alert, __assign({}, props, {
      severity: severity
    }, {
      children: _jsx(LocaleProvider, __assign({
        module: 'storybook'
      }, {
        children: props.color ? (_jsx(FormattedMessage, {
          id: 'alert.default-type.with-color',
          values: {
            name: props.color,
            severity: severity,
          }
        })) : (_jsx(FormattedMessage, {
          id: 'alert.default-type',
          values: {
            severity: severity
          }
        }))
...
var renderColors = function(props) {
  ...
  for (var _i = 0, _a = Object.keys(appTheme.color); _i < _a.length; _i++) {
    var color = _a[_i];
    $elements.push(renderSeverities(__assign(__assign({}, props), {
      color: color
    })));
  }
  return (_jsx(Box, __assign({
