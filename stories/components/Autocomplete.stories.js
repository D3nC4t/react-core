...
var TranslatedAutocomplete = function(props) {
  ...
  return (_jsx(LocaleProvider, __assign({
    ...
    children: _jsxs(Autocomplete, __assign({
...
export var Default = {
  ...
  render: function(props) {
    return (_jsx(TranslatedAutocomplete, __assign({}, props)));
  },
};
    ...
    $groups.push(_jsx(Box, __assign({
      ...
      children: _jsxs(LocaleProvider, __assign({
        ...
        children: [_jsx(FormattedMessage, {
          ...
          children: [_jsx(FormattedMessage, {
            id: 'autocomplete.mutation.single'
          }), _jsx(TranslatedAutocomplete, __assign({
            color: color,
            value: 'test1'
          }, props))]
        })), _jsxs(Typography, __assign({
          ...
          children: [_jsx(FormattedMessage, {
            id: 'autocomplete.mutation.multiple'
          }), _jsx(TranslatedAutocomplete, __assign({
            color: color,
            multiple: true,
            value: ['test1', 'test3']
