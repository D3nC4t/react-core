...
export var CustomSurplus = {
  args: {
    ...
    renderSurplus: function(remaining) {
      return (_jsxs(Avatar, __assign({
        variant: 'outlined',
        boxProps: {
          $bColor: 'grey',
        }
  ...
  for (var _i = 0, _a = Object.keys(appTheme.color); _i < _a.length; _i++) {
    ...
    $groups.push(_jsx(Box, __assign({
      ...
      children: _jsxs(LocaleProvider, __assign({
        ...
        children: [_jsx(Typography, __assign({
        ...
        })), _jsxs(AvatarGroup, __assign({}, props, {
          "$bColor": color,
          "$bgColor": color
        }, {
          children: [_jsx(Avatar, {
            alt: 'Avatar 1',
            src: 'aaa'
          }, 'Avatar 1'), _jsx(Avatar, {
            alt: 'Avatar 2',
            src: 'aaa'
          }, 'Avatar 2'), _jsx(Avatar, {
            alt: 'Avatar 3',
            src: 'aaa'
          }, 'Avatar 3'), _jsx(Avatar, {
            alt: 'Avatar 4',
            src: 'aaa'
          }, 'Avatar 4'), _jsx(Avatar, {
            alt: 'Avatar 5',
            src: 'aaa'
          }, 'Avatar 5')]
          ...
          children: [_jsxs(AvatarGroup, __assign({}, props, {
            max: 3,
            "$bColor": color,
            "$bgColor": color
          }, {
