...
var renderComponentMutations = function(props) {
  var $components = [
    _createElement(Chip, __assign({}, props, {
      key: 'div',
      label: 'div Chip'
    })),
    _createElement(Chip, __assign({}, props, {
...
var AdornmentMutations = function(props) {
  var _a = useTranslations('storybook'),
    intl = _a[0],
    hasLoadedIntl = _a[1];
  var $components = [
    _createElement(Chip, __assign({}, props, {
      ...
      onRemove: function() {
        return console.log('On Remove');
      }
    })),
    _createElement(Chip, __assign({}, props, {
      component: 'button',
      key: 'removable-button',
      label: intl.formatMessage({
        id: 'chip.removable.with-icon'
      }),
      onRemove: function() {
        return console.log('On Remove');
      },
  ...
  return (_jsx(Box, __assign({
    ...
    children: hasLoadedIntl && $components
  })));
};
  ...
  for (var _i = 0, _a = Object.keys(appTheme.color); _i < _a.length; _i++) {
    ...
    $groups.push(_jsxs(Box, __assign({
      ...
      children: [_jsx(Typography, __assign({
        ...
        children: text
      })), renderComponentMutations(props), _jsx(AdornmentMutations, __assign({}, props))]
    }), color));
  }
  return (_jsx(Box, __assign({
    variant: 'flex-row'
