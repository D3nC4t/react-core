...
var ThemeColorsAndMutations = function(props) {
  var _a = useTranslations('storybook'),
    intl = _a[0],
    hasLoadedIntl = _a[1];
  var $startAdornment = (_jsx(Box, __assign({
    jCss: {
      cursor: 'pointer',
  ...
  var $endAdornment = (_jsx(Box, __assign({
    jCss: {
      cursor: 'pointer',
      padding: appTheme.spacing.xs,
      '.invalid & *': {
  ...
  for (var _i = 0, _b = Object.keys(appTheme.color); _i < _b.length; _i++) {
    ...
    $groups.push(_jsxs(Box, __assign({
      ...
      children: [_jsx(Input, __assign({
        ...
        value: intl.formatMessage({
          id: 'input.start-adornment'
        })
      }, props)), _jsx(Input, __assign({
        color: color,
        endAdornment: $endAdornment,
        value: intl.formatMessage({
          id: 'input.end-adornment'
        })
      }, props)), _jsx(Input, __assign({
        color: color,
        endAdornment: $endAdornment,
...
export var Root = {
  ...
  render: function(props) {
    return _jsx(ThemeColorsAndMutations, __assign({}, props));
  },
};
