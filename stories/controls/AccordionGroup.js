...
var AccordionGroupControls = __assign(__assign(__assign({
  children: {
  ...
  variant: {
    ...
    options: __spreadArray([
      undefined
    ], Object.keys((_a = appTheme.components.C4tAccordionGroup.variants) !== null && _a !== void 0 ? _a :
      {}), true),
    control: {
      type: 'select'
    },
...
export default AccordionGroupControls;
