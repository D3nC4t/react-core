...
var BadgeControls = __assign(__assign(__assign({ children: {
        ...
        control: { type: 'select' },
    } }, DefaultC4tControls), ColorControls), _objectWithoutProperties(BoxControls !== null && BoxControls !== void 0 ? BoxControls : {}, ['variant']));
