...
var BoxControls = __assign(__assign({ tag: {
...
export var BoxExtendedControls = __assign({ boxVariant: BoxControls.variant }, _objectWithoutProperties(BoxControls, ['variant']));
