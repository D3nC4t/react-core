...
var DividerControls = __assign(__assign(__assign(__assign({ textAlignment: {
        description: 'The text alignment for the Divider element',
        options: [undefined, 'left', 'center', 'right'],
        control: { type: 'select' },
    }, variant: {
        description: 'The variant for the Divider element',
        options: __spreadArray([
            undefined
        ], Object.keys((_a = appTheme.components.C4tDivider.variants) !== null && _a !== void 0 ? _a : {}), true),
        control: { type: 'select' },
