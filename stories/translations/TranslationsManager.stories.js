  ...
  return (_jsxs(Box, __assign({
    ...
    children: [_jsx(Typography, __assign({
      ...
      children: ["Type the module name:", _jsx(Input, {
        ...
        children: "Download"
      }), objectCode(compareMessages !== null && compareMessages !== void 0 ? compareMessages :
      {}) + 'download')]
          ...
          children: Object.keys(againstMessages).map(function(key) {
            ...
            return (_jsxs(TableRow, __assign({
              jCss: {
                ...
                '&:nth-child(2n)': {
                  backgroundColor: function(theme) {
                    return theme.get.color('white', 'darker');
                  },
                },
              }
            }, {
              children: [_jsx(TableCell, __assign({
                jCss: {
                  padding: function(theme) {
                    return theme.get.rem(theme.spacing.xs, theme
                      .shape.unit);
                  },
                }
              }, {
