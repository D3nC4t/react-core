...
import { faSquare, faSquareCheck, faSquareMinus, faSquarePlus } from '@fortawesome/free-regular-svg-icons';
import { faSquare as faSolidSquare, faSquareCheck as faSolidSquareCheck, faSquareMinus as faSolidSquareMinus, faSquarePlus as faSolidSquarePlus, faSquareXmark as faSolidSquareXmark } from '@fortawesome/free-solid-svg-icons';
var Checkbox = {
    C4tCheckbox: {
        defaultProps: {
            $bColor: 'transparent',
                ...
                styles: function (_a) {
                    ...
                    return _b = {
                        ...
                        _b["& .".concat(baseClassName, "--input")] = {
                            ...
                            border: theme.get.border(theme.shape.border.size, theme.shape.border.unit, theme.shape.border.shape, (_d = props.color) !== null && _d !== void 0 ? _d : 'primary', 'main'),
                            margin: 0,
                            '&:checked': {
