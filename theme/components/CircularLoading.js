    ...
    C4tCircularLoading: {
        ...
        variants: {
                        ...
                        _b["&.".concat(baseClassName)] = (_c = {
                            ...
                            _c["& .".concat(baseClassName, "--inner")] = (_d = {
                                ...
                                _d["&__line"] = {
                                    ...
                                    borderColor: theme.get.color((_f = props.color) !== null && _f !== void 0 ? _f : 'primary', 'lighter'),
                                    borderRadius: '100%',
                                ...
                                _d["&__line:not(:first-of-type)"] = (_e = {
                                    ...
                                    _e["& .".concat(baseClassName, "--inner__line__track")] = {
                                        ...
                                        top: 0,
                                        border: '4px solid transparent',
                                        borderColor: theme.get.color((_g = props.color) !== null && _g !== void 0 ? _g : 'primary', 'main'),
                                        borderRadius: '100%',
                                        content: '""',
                                        height: '100%',
                                        width: '100%',
                                ...
                                _d["&__line"] = (_e = {
                                    ...
                                    _e["&:nth-child(2)"] = (_g = {
                                        ...
                                        _g["& .".concat(baseClassName, "--inner__line__track")] = {
                                            borderColor: props.color
                                                ? theme.get.rgba((_p = props.color) !== null && _p !== void 0 ? _p : 'primary', 0.86, 'main')
                                                : 'hsl(35,86%,52%)',
                                            height: '90px',
                                            width: '90px',
                                            top: '7px',
                                    ...
                                    _e["&:nth-child(3)"] = (_h = {
                                        ...
                                        _h["& .".concat(baseClassName, "--inner__line__track")] = {
                                            borderColor: props.color
                                                ? theme.get.rgba((_q = props.color) !== null && _q !== void 0 ? _q : 'primary', 0.72, 'main')
                                                : 'hsl(46,77%,55%)',
                                            height: '76px',
                                            width: '76px',
                                            top: '14px',
                                    ...
                                    _e["&:nth-child(4)"] = (_j = {
                                        ...
                                        _j["& .".concat(baseClassName, "--inner__line__track")] = {
                                            borderColor: props.color
                                                ? theme.get.rgba((_r = props.color) !== null && _r !== void 0 ? _r : 'primary', 0.58, 'main')
                                                : 'hsl(116,65%,53%)',
                                            height: '62px',
                                            width: '62px',
                                            top: '21px',
                                    ...
                                    _e["&:nth-child(5)"] = (_k = {
                                        ...
                                        _k["& .".concat(baseClassName, "--inner__line__track")] = {
                                            borderColor: props.color
                                                ? theme.get.rgba((_s = props.color) !== null && _s !== void 0 ? _s : 'primary', 0.44, 'main')
                                                : 'hsl(201,81%,58%)',
                                            height: '48px',
                                            width: '48px',
                                            top: '28px',
                                    ...
                                    _e["&:nth-child(7)"] = (_m = {
                                        ...
                                        _m["& .".concat(baseClassName, "--inner__line__track")] = {
                                            borderColor: props.color
                                                ? theme.get.rgba((_u = props.color) !== null && _u !== void 0 ? _u : 'primary', 0.16, 'main')
                                                : 'hsl(254,63%,47%)',
                                            height: '20px',
                                            width: '20px',
                                            top: '42px',
            ...
            'svg': {
                props: {
                    lines$el: {
                        0: _jsx("svg", __assign({ className: "spinner", viewBox: "0 0 50 50" }, { children: _jsx("circle", { className: "path", cx: "25", cy: "25", r: "20", fill: "none", strokeWidth: "5" }) })),
                    }
                },
                styles: function (_a) {
                    var _b;
