          ...
          return _a = {
            ...
            _a["& .".concat(baseClass, "--divider")] = {
              ...
              '&:after': {
                ...
                border: function(theme, props) {
                  var _a, _b;
                  return theme.get.border(theme.shape.border.size, theme.shape.border.unit, theme.shape.border
                    .shape, (_a = props.color) !== null && _a !== void 0 ? _a : 'primary', (_b = props
                      .colorVariant) !== null && _b !== void 0 ? _b : 'main');
                },
                left: 0,
                position: 'absolute',
                top: '50%',
            ...
            _a["&.align-left .".concat(baseClass, "--divider.main")] = {
              width: function(theme) {
                return theme.get.rem(theme.spacing.xxl, theme.shape.unit);
              },
              flexGrow: 0,
            },
