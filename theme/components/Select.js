        ...
        variants: {
            ...
            'dashed': {
                styles: function (_a) {
                    ...
                    return _b = {},
                        _b["& .".concat(baseClass, "__input")] = {
                            border: theme.get.border(theme.shape.border.size, theme.shape.border.unit, 'dashed', (_d = props.color) !== null && _d !== void 0 ? _d : 'primary', (_e = props.colorVariant) !== null && _e !== void 0 ? _e : 'main'),
                            borderBottom: theme.get.border(theme.shape.border.size, theme.shape.border.unit, 'dashed', (_f = props.color) !== null && _f !== void 0 ? _f : 'primary', (_g = props.colorVariant) !== null && _g !== void 0 ? _g : 'main'),
                            '&.invalid': {
                                border: theme.get.border(theme.shape.border.size, theme.shape.border.unit, 'dashed', 'error', props.color === 'error' ? 'light' : 'main'),
                            },
                            '&.disabled': {
                                border: theme.get.border(theme.shape.border.size, theme.shape.border.unit, 'dashed', 'grey', 'lighter'),
                            },
                        },
                        _b["& .".concat(baseClass, "__options")] = (_c = {
                                border: theme.get.border(theme.shape.border.size, theme.shape.border.unit, 'dashed', (_h = props.color) !== null && _h !== void 0 ? _h : 'primary', (_j = props.colorVariant) !== null && _j !== void 0 ? _j : 'dark')
                            },
                            _c["& .".concat(baseClass, "__option")] = {
                                border: theme.get.border(theme.shape.border.size, theme.shape.border.unit, 'dashed', 'transparent'),
                                minWidth: theme.get.rem(((_k = props.width) !== null && _k !== void 0 ? _k : 128) - (theme.spacing.s + theme.spacing.xs * 2), 'px'),
                                '&.selected': {
                                    backgroundColor: theme.get.color('white', 'main'),
                                    border: theme.get.border(theme.shape.border.size, theme.shape.border.unit, 'dashed', (_l = props.color) !== null && _l !== void 0 ? _l : 'primary', (_m = props.colorVariant) !== null && _m !== void 0 ? _m : 'dark'),
                                    '& > svg': {
            ...
            'dotted': {
                styles: function (_a) {
                    ...
                    return _b = {},
                        _b["& .".concat(baseClass, "__input")] = {
                            border: theme.get.border(theme.shape.border.size, theme.shape.border.unit, 'dotted', (_d = props.color) !== null && _d !== void 0 ? _d : 'primary', (_e = props.colorVariant) !== null && _e !== void 0 ? _e : 'main'),
                            borderBottom: theme.get.border(theme.shape.border.size, theme.shape.border.unit, 'dotted', (_f = props.color) !== null && _f !== void 0 ? _f : 'primary', (_g = props.colorVariant) !== null && _g !== void 0 ? _g : 'main'),
                            '&.invalid': {
                                border: theme.get.border(theme.shape.border.size, theme.shape.border.unit, 'dotted', 'error', props.color === 'error' ? 'light' : 'main'),
                            },
                            '&.disabled': {
                                border: theme.get.border(theme.shape.border.size, theme.shape.border.unit, 'dotted', 'grey', 'lighter'),
                            },
                        },
                        _b["& .".concat(baseClass, "__options")] = (_c = {
                                border: theme.get.border(theme.shape.border.size, theme.shape.border.unit, 'dotted', (_h = props.color) !== null && _h !== void 0 ? _h : 'primary', (_j = props.colorVariant) !== null && _j !== void 0 ? _j : 'dark')
                            },
                            _c["& .".concat(baseClass, "__option")] = {
                                ...
                                '&.selected': {
                                    backgroundColor: theme.get.color('white', 'main'),
                                    border: theme.get.border(theme.shape.border.size, theme.shape.border.unit, 'dotted', (_l = props.color) !== null && _l !== void 0 ? _l : 'primary', (_m = props.colorVariant) !== null && _m !== void 0 ? _m : 'dark'),
                                    '& > svg': {
                                        color: theme.get.color((_o = props.color) !== null && _o !== void 0 ? _o : 'primary', 'main'),
                                    },
                                },
            ...
            'round-outlined': {
                styles: function (_a) {
                    ...
                    return _b = {},
                        _b["& .".concat(baseClass, "__input")] = {
                            border: theme.get.border(theme.shape.border.size, theme.shape.border.unit, theme.shape.border.shape, (_d = props.color) !== null && _d !== void 0 ? _d : 'primary', (_e = props.colorVariant) !== null && _e !== void 0 ? _e : 'main'),
                            borderRadius: "".concat(theme.shape.border.radius).concat(theme.shape.border.unit),
                            '&.invalid': {
                                border: theme.get.border(theme.shape.border.size, theme.shape.border.unit, theme.shape.border.shape, 'error', props.color === 'error' ? 'light' : 'main'),
                            },
                            '&.disabled': {
                                border: theme.get.border(theme.shape.border.size, theme.shape.border.unit, theme.shape.border.shape, 'grey', 'lighter'),
                            },
                        },
                        _b["& .".concat(baseClass, "__options")] = (_c = {
                                border: theme.get.border(theme.shape.border.size, theme.shape.border.unit, theme.shape.border.shape, (_f = props.color) !== null && _f !== void 0 ? _f : 'primary', (_g = props.colorVariant) !== null && _g !== void 0 ? _g : 'dark'),
                                borderRadius: "".concat(theme.shape.border.radius).concat(theme.shape.border.unit)
                            },
                            _c["& .".concat(baseClass, "__option")] = {
                                border: theme.get.border(theme.shape.border.size, theme.shape.border.unit, theme.shape.border.shape, 'transparent'),
                                borderRadius: "".concat(theme.shape.border.radius).concat(theme.shape.border.unit),
                                minWidth: theme.get.rem(((_h = props.width) !== null && _h !== void 0 ? _h : 128) - (theme.spacing.s + theme.spacing.xs * 2), 'px'),
                                '&.selected': {
                                    backgroundColor: theme.get.color('white', 'main'),
                                    border: theme.get.border(theme.shape.border.size, theme.shape.border.unit, theme.shape.border.shape, (_j = props.color) !== null && _j !== void 0 ? _j : 'primary', (_k = props.colorVariant) !== null && _k !== void 0 ? _k : 'dark'),
                                    '& > svg': {
                ...
                styles: function (_a) {
                    ...
                    return _b = {},
                        ...
                        _b["& .".concat(baseClass, "__options")] = (_c = {
                            ...
                            _c["& .".concat(baseClass, "__option")] = {
                                borderRadius: "".concat(theme.shape.border.radius).concat(theme.shape.border.unit),
                                minWidth: theme.get.rem(((_d = props.width) !== null && _d !== void 0 ? _d : 128) - (theme.spacing.s + theme.spacing.xs * 2), 'px'),
                            },
            ...
            'shadowed': {
                styles: function (_a) {
                    ...
                    return _b = {},
                        _b["& .".concat(baseClass, "__input")] = {
                            borderBottom: theme.get.border(theme.shape.border.size, theme.shape.border.unit, theme.shape.border.shape, 'transparent'),
                            boxShadow: theme.get.shadow(__assign(__assign({}, theme.shadow.bottom), { color: theme.get.rgba((_d = props.color) !== null && _d !== void 0 ? _d : 'primary', 0.4, 'main') })),
                            '&.invalid': {
                                borderBottom: theme.get.border(theme.shape.border.size, theme.shape.border.unit, theme.shape.border.shape, 'transparent'),
                                boxShadow: theme.get.shadow(__assign(__assign({}, theme.shadow.bottom), { color: theme.get.rgba('error', 0.2, props.color === 'error' ? 'light' : 'main') })),
                            },
                            '&.disabled': {
                                borderBottom: theme.get.border(theme.shape.border.size, theme.shape.border.unit, theme.shape.border.shape, 'transparent'),
                                boxShadow: theme.get.shadow(__assign(__assign({}, theme.shadow.bottom), { color: theme.get.rgba('grey', 0.2, 'lighter') })),
                            },
                        },
                        _b["& .".concat(baseClass, "__options")] = (_c = {
                                boxShadow: theme.get.shadow(__assign(__assign({}, theme.shadow.bottom), { color: theme.get.rgba((_e = props.color) !== null && _e !== void 0 ? _e : 'primary', 0.4, 'main') }))
                            },
                            _c["& .".concat(baseClass, "__option")] = {
                                boxShadow: theme.get.shadow(__assign(__assign({}, theme.shadow.bottom), { color: theme.get.rgba((_f = props.color) !== null && _f !== void 0 ? _f : 'primary', 0.4, 'main') })),
                                '&.selected': {
                                    backgroundColor: theme.get.color('white', 'main'),
                                    boxShadow: theme.get.shadow(__assign(__assign({}, theme.shadow.bottom), { color: theme.get.rgba((_g = props.color) !== null && _g !== void 0 ? _g : 'primary', 0.4, 'dark') })),
