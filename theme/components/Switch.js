          ...
          return (__assign({}, makeVariants(['root', 'contained', 'rounded', 'round-contained'], function(variant) {
            ...
            return _a = {
              ...
              _a["& .".concat(baseClass, "--thumb")] = {
                ...
                backgroundColor: theme.get.color((_c = props.color) !== null && _c !== void 0 ? _c :
                  'primary', 'text'),
                '&.checked': {
                  backgroundColor: theme.get.color((_d = props.color) !== null && _d !== void 0 ? _d :
                    'primary', 'main'),
      ...
      'round-contained': {
        styles: function(_a) {
          ...
          var theme = _a.theme,
            props = __rest(_a, ["theme"]);
          return (_b = {
              backgroundColor: theme.get.color((_c = props.color) !== null && _c !== void 0 ? _c : 'primary',
                'lighter'),
              borderColor: 'transparent',
              borderRadius: theme.get.rem(theme.shape.border.radius, theme.shape.border.unit)
            },
