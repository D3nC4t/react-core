...
export default function useDefaultProps(inputProps, componentName, defaultVariant, theme) {
    ...
    var _a = useState({}), useProps = _a[0], setUseProps = _a[1];
    useEffect(function () {
        var _a, _b, _c, _d;
        ...
        if (!variant || variant === '') {
            variant = (_b = (_a = defaultProps.variant) !== null && _a !== void 0 ? _a : defaultVariant) !== null && _b !== void 0 ? _b : 'root';
        }
        var variantProps = (_d = (component.variants && ((_c = component.variants[variant]) === null || _c === void 0 ? void 0 : _c.props))) !== null && _d !== void 0 ? _d : {};
        var baseProps = merge({ variant: variant }, defaultProps, variantProps);
        for (var _i = 0, _e = Object.keys(baseProps); _i < _e.length; _i++) {
            var prop = _e[_i];
            var value = baseProps[prop];
            if (typeof value === 'function') {
                value = value(__assign(__assign({}, inputProps), { name: componentName, variant: variant }));
            }
            baseProps[prop] = value;
        }
        setUseProps(merge(baseProps, inputProps, { variant: variant }));
