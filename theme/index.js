...
export function ThemeCustomization(_a) {
    var $el = _a.$el, children = _a.children, _b = _a.theme, otherTheme = _b === void 0 ? {} : _b;
    var cache = createCache(__assign({ key: 'css', prepend: true }, ($el && { container: $el })));
    return (_jsx(React.StrictMode, { children: _jsx(CacheProvider, __assign({ value: cache }, { children: _jsx(ThemeProvider, __assign({ theme: merge({}, theme, otherTheme) }, { children: children })) })) }));
}
