...
export default function createStyled(options) {
  ...
  var _a = options.theme,
    defaultTheme = _a === void 0 ? baseTheme : _a,
    _b = options.jCssFunction,
    jCssFunction = _b === void 0 ? defaultJCssFunction : _b;
  var systemJCss = function(props) {
    var theme = isObjectEmpty(props.theme) ? defaultTheme : props.theme;
    return jCssFunction(_extends({}, props, {
      theme: theme
    }));
  };
  ...
  function createC4tStyled(tag, stylesOptions) {
    if (stylesOptions === void 0) {
      stylesOptions = {};
    }
    var componentName = stylesOptions.name,
      slot = stylesOptions.slot,
      _a = stylesOptions.skipJCss,
      skipJCss = _a === void 0 ? false : _a,
      _b = stylesOptions.dontForwardProp,
      dontForwardProp = _b === void 0 ? [] : _b,
      _c = stylesOptions.forwardProps,
      forwardProps = _c === void 0 ? [] : _c;
    ...
    var defaultStyledResolver = emotionStyled(tag, _extends({
      shouldForwardProp: function(prop) {
        return forwardProps.includes(prop) || !(__spreadArray(['jCss', 'theme'], dontForwardProp, true)
          .includes(prop) ||
          prop.startsWith('$'));
      },
      label: label
    ...
    var jCssStylesResolver = function(template) {
      ...
      var Component = defaultStyledResolver.apply(void 0, __spreadArray([
        []
      ], stylesWithDefaultTheme, false));
      if (process.env.NODE_ENV !== 'production') {
