var shadow = function (theme) { return function (bShadow) {
    ...
    return "".concat(position, " ").concat(shadow.blur).concat(shadow.unit, " ").concat(shadow.spread).concat(shadow.unit, " ").concat(shadow.color);
}; };
