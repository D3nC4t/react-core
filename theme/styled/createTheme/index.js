...
export function createTheme(theme) {
    ...
    var _f = theme.breakpoints, breakpointsInput = _f === void 0 ? {} : _f, _g = theme.color, colorInput = _g === void 0 ? {} : _g, _h = theme.components, components = _h === void 0 ? {} : _h, _j = theme.shape, shape = _j === void 0 ? {} : _j, _k = theme.spacing, spacingInput = _k === void 0 ? {} : _k, _l = theme.typography, typography = _l === void 0 ? {} : _l;
    ...
    c4tTheme = slices.reduce(function (acc, slice) { return merge(acc, slice); }, c4tTheme);
    c4tTheme.shadow = merge(c4tTheme.shadow, createShadows(c4tTheme));
    !(theme && ((_a = theme.get) === null || _a === void 0 ? void 0 : _a.border)) && (c4tTheme.get.border = border(c4tTheme));
    !(theme && ((_b = theme.get) === null || _b === void 0 ? void 0 : _b.color)) && (c4tTheme.get.color = color(c4tTheme));
    ...
    !(theme && ((_e = theme.get) === null || _e === void 0 ? void 0 : _e.shadow)) && (c4tTheme.get.shadow = shadow(c4tTheme));
