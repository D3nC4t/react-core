    ...
    set: function (target, module, value) {
        target[module] = new Proxy({}, {
            set: function (set, locale, messages) {
                var _a, _b;
                set[locale] = messages;
                for (var _i = 0, _c = Object.values((_b = (_a = subscriptions[module]) === null || _a === void 0 ? void 0 : _a[locale]) !== null && _b !== void 0 ? _b : {}); _i < _c.length; _i++) {
                    var handler = _c[_i];
                    handler(messages);
                }
                return true;
        ...
        for (var _i = 0, _a = Object.entries(value); _i < _a.length; _i++) {
            var _b = _a[_i], locale = _b[0], messages = _b[1];
            target[module][locale] = messages;
        }
        return true;
    }
});
var loadModuleIfExists = function (path) { return __awaiter(void 0, void 0, void 0, function () {
    var e_1;
    var _a;
...
export var loadCoreI18nModuleData = function (locale, module, skipDefault) {
    if (module === void 0) { module = DEFAULT_MODULE; }
        ...
        return __generator(this, function (_f) {
            switch (_f.label) {
                ...
                case 4:
                    ...
                    _b = undefined;
                    return [3 /*break*/, 7];
                case 5: return [4 /*yield*/, loadModuleIfExists("".concat(defaultLocale, "/").concat(module, ".json"))];
                case 6:
                    _b = _f.sent();
                    _f.label = 7;
                case 7:
                ...
                case 8:
                    ...
                    registerModuleLocale(module, locale, merge({}, (_d = defaultModule === null || defaultModule === void 0 ? void 0 : defaultModule.default) !== null && _d !== void 0 ? _d : {}, (_e = specificModule === null || specificModule === void 0 ? void 0 : specificModule.default) !== null && _e !== void 0 ? _e : {}));
                    _f.label = 9;
                case 9: return [2 /*return*/, getModuleLocale(module, locale)];
            }
        });
    });
};
...
export function getModuleLocale(module, locale) {
    var _a, _b;
    return (_b = (_a = getModule(module)) === null || _a === void 0 ? void 0 : _a[locale]) !== null && _b !== void 0 ? _b : undefined;
}
